...
<html lang="en">
    ...
    <form class="container">
        ...
        <fieldset class="radio-group">
            ...
            <div class="radio">
                <label for="expedite">
                    <input id="expedite" type="radio" value="expedite" name="delivery" required>
                    I need this book faster
                </label>
            </div>
        </fieldset>

        <button type="submit" value="submit" class="btn btn-warning btn-submit" id="submitBtn">Submit</button>
